...
Фобия: ${data.phobia}
Багаж: ${data.luggage}
Дополнительная информация: ${data.additionalInformation}
Тип тела: ${data.bodyType}
Вы можете присоединиться к нашему выживанию ${window.location.origin}/index.html`;
